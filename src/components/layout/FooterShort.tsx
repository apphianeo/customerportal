...
export default function FooterShort() {
  return (
    <footer className="bg-primary text-white font-normal leading-relaxed">
      ...
      <div className="sm:hidden px-[24px] py-[12px] text-center text-xs">
        {COPYRIGHT} {RIGHTS}
      </div>

      {/* Desktop — split across the full width */}
      <div className="hidden sm:flex flex-row items-center justify-between gap-3 px-[24px] py-[12px] text-xs lg:text-sm">
        <span>{COPYRIGHT}</span>
