...
**Two lines are shared across all five emails** (marked SHARED below). Editing
one changes all five.

---

## 1. Login OTP · `01-login-otp.html`

- **Subject:** {{otp_code}} is your UOI Customer Portal login code
- **Preheader:** Expires in 3 minutes. UOI will never ask you for this code.

| Slot | Copy |
|---|---|
| Heading | Your login code |
| Intro | Hi {{first_name}}, please enter this code in the window where you started signing in to UOI Customer Portal. |
| Code | {{otp_code}} |
...
| Tier 3, SHARED | **UOI will never ask you** for your OTP, password or card details by phone, email or SMS. If someone does, hang up and call [(+65) 6222 7733]. |
...
- **Subject:** {{otp_code}} is your UOI Customer Portal verification code
...
- **Subject:** {{otp_code}} is your code to confirm your new login ID
